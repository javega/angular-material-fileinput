(function(window,angular,undefined) {
    ...
    lfNgMdFileinput.run(['$templateCache', function($templateCache){
        $templateCache.put('lfNgMdFileinput.html', [
            '<div layout="column" class="lf-ng-md-file-input new-design" ng-model="'+genLfObjId()+'">',
            '<div class="div-responsive">',
            '<div layout="column" layout-xs="row" layout-sm="column"  class="lf-ng-md-file-input-preview-container" ng-class="{\'disabled\':isDisabled}" ng-show="isDrag || (isPreview && lfFiles.length)">',
            ...
            '</div>',
            '</div>',
            '<div layout="row" layout-xs="column" layout-sm="column" class="lf-ng-md-file-input-container" >',
            '<div class="lf-ng-md-file-input-caption" layout="row" layout-align="start center" flex ng-class="{\'disabled\':isDisabled}" >',
            '<md-icon class="lf-icon">{{strCaptionIconCls}}</md-icon>',
            ...
            '</div>',
            '<md-button aria-label="remove all files" ng-disabled="isDisabled" ng-click="removeAllFiles()" ng-hide="!lfFiles.length || intLoading" class="md-primary md-cornered lf-ng-md-file-input-button lf-ng-md-file-input-button-remove" style="top: 2px;">',
            '{{strCaptionRemove}}',
            '</md-button>',
            '<md-spacer></md-spacer>',
            '<md-button ng-disabled="isDisabled" ng-click="openDialog($event, this)" class="md-raised md-cornered md-primary lf-ng-md-file-input-button lf-ng-md-file-input-button-brower" style="height: 38px; top:2px;">',
            '<md-icon class="lf-icon">{{strBrowseIconCls}}</md-icon> ',
            '{{strCaptionBrowse}}',
